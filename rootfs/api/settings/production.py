...
USER_BASEDN = os.environ.get('LDAP_USER_BASEDN', '')
USER_FILTER = os.environ.get('LDAP_USER_FILTER', '')
GROUP_BASEDN = os.environ.get('LDAP_GROUP_BASEDN', '')
GROUP_FILTER = os.environ.get('LDAP_GROUP_FILTER', '')
GROUP_TYPE = os.environ.get('LDAP_GROUP_TYPE', '')
